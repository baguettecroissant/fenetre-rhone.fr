...
const SITE_DOMAIN = 'fenetre-rhone.fr';
const SITE_NICHE = 'fenetre';
const DEPT_CODE = '69';
...
// ── Category name mapping for Fenêtres ──
const CAT_NAMES = {
  72: 'Fenêtre (Double/Triple vitrage)',
  10: 'Menuiserie (Baie vitrée ou Porte-fenêtre)',
  147: 'Volets roulants',
